...
city = "成都市"  # 修改7：女王市
district = "新都区"  # 修改8：游乐区
signArea = "西南石油大学"  # 修改9：巴啦啦魔法大学，或其他地址
...
class answer:
    def __init__(self):
        ...
        self.api = "https://gw.wozaixiaoyuan.com/health/mobile/health/save?batch=5600001"
        self.headers = {
            "Host": "gw.wozaixiaoyuan.com",
            "Content-Type": "application/json;charset=UTF-8",
            "Accept": "application/json, text/plain, */*",
        ...
        self.data = json.dumps( {"location":"中国/福建省/福州市/晋安区/新店镇/南平西路/156/350111/156350100/350111101",
                                 "t1":"[\"无下列情况\"]",
                                 "t2":"无不适症状",
                                 "t3":"暑假已离校",
                                 "t4":"未列为风险区",
